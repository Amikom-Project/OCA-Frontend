...
import { ListPPh21PenerimaVerifikasi } from '@/pages/dashboard/pph-21/queries';
...
import PPh21PenerimaTable from '../pph-21-penerima-table';

export default function PPh21VerifikasiPage() {
  ...
  const { data } = ListPPh21PenerimaVerifikasi(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 21 Verifikasi' />
      <div className='flex-1 space-y-4 px-4 md:px-8'>
        <Card className='border-none drop-shadow-sm'>
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
            <CardHeader className='space-y-4'>
              <CardTitle className='text-xl line-clamp-1'>
                Data PPh 21 Verifikasi
              </CardTitle>
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Data PPh 21 Verifikasi</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
              <Link to='/dashboard'>
