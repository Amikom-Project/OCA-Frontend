...
import { ListPPh21PenerimaEntry } from '@/pages/dashboard/pph-21/queries';
...
export default function PPh21EntryPage() {
  ...
  const { data } = ListPPh21PenerimaEntry(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 21 Entry' />
            ...
            <CardHeader className='space-y-4'>
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Data PPh 21 Entry</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
              <Link to='/dashboard'>
