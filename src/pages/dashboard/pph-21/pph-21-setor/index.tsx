...
import { ListPPh21PenerimaSetor } from '@/pages/dashboard/pph-21/queries';
...
export default function PPh21SetorPage() {
  ...
  const { data } = ListPPh21PenerimaSetor(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 21 Setor' />
            ...
            <CardHeader className='space-y-4'>
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Data PPh 21 Setor</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
              <Link to='/dashboard'>
