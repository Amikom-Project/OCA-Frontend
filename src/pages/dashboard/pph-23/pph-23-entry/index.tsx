...
import { ListPPh23Entry } from '@/pages/dashboard/pph-23/queries';
...
export default function PPh23EntryPage() {
  ...
  const { data } = ListPPh23Entry(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 23 Entry' />
            ...
            <CardHeader className='space-y-4'>
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Data PPh 23 Entry</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
              <Link to='/dashboard'>
