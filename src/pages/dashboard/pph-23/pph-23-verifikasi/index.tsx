...
import { ListPPh23Verifikasi } from '@/pages/dashboard/pph-23/queries';
...
export default function PPh23VerifikasiPage() {
  ...
  const { data } = ListPPh23Verifikasi(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 23 Verifikasi' />
      <div className='flex-1 space-y-4 px-4 md:px-8'>
        <Card className='border-none drop-shadow-sm'>
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
            <CardHeader className='space-y-4'>
              <CardTitle className='text-xl line-clamp-1'>
                Data PPh 23 Verifikasi
              </CardTitle>
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Data PPh 23 Verifikasi</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
              <Link to='/dashboard'>
