...
import { ListPPh4Ayat2Verifikasi } from '@/pages/dashboard/pph-4-ayat-2/queries';
...
export default function PPh4Ayat2VerifikasiPage() {
  ...
  const { data } = ListPPh4Ayat2Verifikasi(idl, page, limit, token, search);
  ...
  return (
    <>
      <PageHead title='Data PPh 4 Ayat 2 Verifikasi' />
      <div className='flex-1 space-y-4 px-4 md:px-8'>
        <Card className='border-none drop-shadow-sm'>
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
            <CardHeader className='space-y-4'>
              <CardTitle className='text-xl line-clamp-1'>
                Data PPh 4 Ayat 2 Verifikasi
              </CardTitle>
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
