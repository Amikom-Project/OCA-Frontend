...
import { Create } from '@/api/wajib-pajak-badan-usaha-api';
...
export default function FormTambahWajibPajakBadanUsaha() {
  ...
  const onSubmit = async (data: TWajibPajakBadanUsahaFormSchema) => {
    const formData = {
      ...data,
      // file_foto_identitas_badan: base64File || '',
      // file_foto_npwp: base64File || '',
      // file_foto_bukti_rekening: base64File || '',
      // file_surat_bebas_pph23: base64File || '',
    };
