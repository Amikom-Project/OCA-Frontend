...
import { TPPh23FormSchema, TPPh23Model } from '@/types/pph-23-type';
...
import { Update } from '@/api/pph-23-api';

type FormEditPPh23Props = {
  initialData?: TPPh23Model | null;
};

export default function FormEditPPh23({ initialData }: FormEditPPh23Props) {
    ...
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
          ...
          <FormField
            control={form.control}
            name={getFieldsMetaDataPPh23.kode_objek_pajak.id}
            render={({ field }) => (
              <FormItem>
                <FormLabel>
